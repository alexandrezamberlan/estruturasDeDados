...
int main() {
    ...
    double media = somarElementos(listaOriginalGlicemia) / contarElementos(listaOriginalGlicemia);
    cout <<  "Média da Glicemia: " << media << endl;
    fprintf(procuradorSaida, "Média da Glicemia: %.2f\n", media);

    media = somarElementos(listaOriginalInsulina) / contarElementos(listaOriginalInsulina);
    cout <<  "Média da Insulina: " << media << endl;
    fprintf(procuradorSaida, "Média da Insulina: %.2f\n", media);

    media = somarElementos(listaOriginalCalorias) / contarElementos(listaOriginalCalorias);
    cout <<  "Média da Calorias: " << media << endl;
    fprintf(procuradorSaida, "Média da Calorias: %.2f\n", media);

    media = somarElementos(listaOriginalCarboidrato) / contarElementos(listaOriginalCarboidrato);
