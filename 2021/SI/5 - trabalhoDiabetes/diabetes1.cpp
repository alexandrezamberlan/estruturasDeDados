...
int main() {
    ...
    //tratar o arquivo de entrada: abrir e extrair os dados para lista oficial e uma ordenada (mediana)
        //inserir ordenado na listaOrdenada
        //inserir sem ordenacao na listaOriginal
